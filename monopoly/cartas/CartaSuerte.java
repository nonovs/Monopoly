...
public class CartaSuerte extends Carta {
    ...
    public boolean accion(Tablero tablero,
        ...
        switch (id) {
            ...
            case 2:
                ...
                System.out.println("Carta Suerte 2: Los acreedores te persiguen. Vas directamente a la Carcel.");
                Casilla carcel = tablero.getCasilla(10);
                if (carcel != null) {
                    actual.enviarACarcel(carcel);
                    System.out.printf("%s ha sido enviado a la carcel.%n", actual.getNombre());
                } else {
            ...
            case 3:
                ...
                System.out.println("Carta Suerte 3: ¡Has ganado el bote de la loteria! Recibes 1.000.000€.");
            ...
            case 5:
                ...
                System.out.println("Carta Suerte 5: ¡Hora punta de trafico! Retrocedes tres casillas.");
            ...
            case 6:
                ...
                System.out.println("Carta Suerte 6: Te multan por usar el movil mientras conduces. Pagas 150.000€.");
            ...
            case 7:
                ...
                System.out.println("Carta Suerte 7: Avanza hasta el transporte mas cercano.");
    ...
    private void moverPorCarta(Tablero tablero,
        ...
        if (evaluarDestino && destino != null && !destino.esIrACarcel()) {
            ...
            if (!ok) {
                System.out.println("No has podido pagar tras la accion de la carta de Suerte.");
            }
        }
    }
}
