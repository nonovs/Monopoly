...
public class CartaCajaComunidad extends Carta {
    ...
    public boolean accion(Tablero tablero,
        ...
        switch (id) {
            ...
            case 2:
                ...
                System.out.println("Carta Comunidad 2: Te investigan por fraude de identidad. Vas a la Carcel.");
            ...
            case 3:
                ...
                System.out.printf("%s cobra %.0f€ por situarse en Salida.%n",
                        actual.getNombre(), Valor.SUMA_VUELTA);
                return true;

            case 4:
                // 4. Devolución de Hacienda: cobras 500.000€
                System.out.println("Carta Comunidad 4: Devolucion de Hacienda. Cobras 500.000€.");
            ...
            case 5:
                ...
                System.out.println("Carta Comunidad 5: Retrocedes hasta Solar1 para comprar antiguedades.");
                moverPorCarta(tablero, actual, banca, 1, false, tirada, true);
                return true;

            case 6:
                // 6. Ve a Solar20 (pos 34). Si pasas por Salida, cobras 2M.
                System.out.println("Carta Comunidad 6: Vas a Solar20 para disfrutar de San Fermin.");
    ...
    private void moverPorCarta(Tablero tablero,
        ...
        if (evaluarDestino && destino != null && !destino.esIrACarcel()) {
            ...
            if (!ok) {
                System.out.println("No has podido pagar tras la accion de la carta de Caja de Comunidad.");
            }
        }
    }
}
